class CentersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to centers_path, status: :see_other, notice: "Center was successfully destroyed." }
  ...
  private
    ...
    def set_center
      @center = Center.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def center_params
      params.expect(center: [ :name, :subdomain ])
    end
end
