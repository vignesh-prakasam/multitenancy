...
class CentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create center" do
    assert_difference("Center.count") do
      post centers_url, params: { center: { name: @center.name, subdomain: @center.subdomain } }
    end
  ...
  test "should update center" do
    patch center_url(@center), params: { center: { name: @center.name, subdomain: @center.subdomain } }
