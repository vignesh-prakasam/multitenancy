...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference("Family.count") do
      post families_url, params: { family: { center_id: @family.center_id, name: @family.name } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { center_id: @family.center_id, name: @family.name } }
